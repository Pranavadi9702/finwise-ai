  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-border bg-card">
      ...
      <div className="border-t border-border p-4">
        ...
        <button className="mt-2 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-danger transition-all duration-200 hover:bg-danger-soft">
